      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {(user.role === 'admin' || user.role === 'superadmin') && (
          loading ? (
            ...
            <div className="grid grid-cols-2 gap-3 mb-6 md:mb-8 md:gap-4">
              <Link to="/admin/attendance-log" className="bg-gradient-to-br from-green-500/20 to-green-600/5 border border-green-500/20 hover:border-green-500/50 p-4 md:p-6 rounded-2xl flex flex-col md:flex-row items-start md:items-center justify-between gap-3 md:gap-0 transition-all group cursor-pointer block">
                <div>
              ...
              <Link to="/admin/leaves" className="bg-gradient-to-br from-yellow-500/20 to-yellow-600/5 border border-yellow-500/20 hover:border-yellow-500/50 p-4 md:p-6 rounded-2xl flex flex-col md:flex-row items-start md:items-center justify-between gap-3 md:gap-0 transition-all group cursor-pointer block">
                <div>
